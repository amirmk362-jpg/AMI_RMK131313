...
function observeCards() {
      ...
      function (entries) {
        entries.forEach(function (en) {
          if (en.isIntersecting) {
            ...
            _cardObserver.unobserve(en.target);
          }
        });
      },
      { threshold: 0.12 },
  ...
  document
    .querySelectorAll(".g-card:not(.visible),.p-card:not(.visible)")
    .forEach(function (c) {
...
var _prevBadgeTotal = cart.reduce(function (s, i) {
  return s + i.qty;
}, 0);
function saveCart() {
